...
from api.utils import generate_ticket_number
...
class EventOrder(models.Model):
    ...
    event = models.ForeignKey(to=Event, on_delete=models.CASCADE, related_name='event_orders')
    customer = models.ForeignKey(to=Customer, on_delete=models.CASCADE, related_name='event_orders')
...
class EventTicket(models.Model):
    ticket_number = models.CharField(max_length=20, default=generate_ticket_number(), editable=False, unique=True)
    event = models.ForeignKey(to=Event, on_delete=models.CASCADE, related_name='event_tickets')
    attendee_type = models.ForeignKey(to=AttendeeType, on_delete=models.CASCADE, related_name='event_tickets')
